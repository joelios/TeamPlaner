...
ath.intl = {
	...
	de_de: {
		ios: 'Der <strong>TeamPlaner</strong> ist eine Web-App. Für eine ideale Darstellung muss diese zum Home-Bildschirm hinzuzufügen werden. Tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.',
		android: 'Der <strong>TeamPlaner</strong> ist eine Web-App. Für eine ideale Darstellung muss diese zum Startbildschirm hinzuzufügen werden. Öffnen Sie das Menü und tippen dann auf <strong>Zum Startbildschirm hinzufügen</strong>. <small>Wenn Ihr Gerät eine Menütaste hat, lässt sich das Browsermenü über diese öffnen. Ansonsten tippen Sie auf %icon.</small>'
	},
